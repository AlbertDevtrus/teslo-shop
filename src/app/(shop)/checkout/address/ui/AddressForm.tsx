...
export const AddressForm = ({ countries, userStoreAddress = {} }: Props) => {
  ...
  const { handleSubmit, register, formState: { isValid }, reset } = useForm<Inputs>({
    defaultValues: {
      ...
      <div className="flex flex-col mb-2 sm:mb-1">
        <div className="inline-flex items-center mb-10">
          ...
          >
            <input
              type="checkbox"
              className="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-blue-500 checked:bg-blue-500 checked:before:bg-blue-500 hover:before:opacity-10 border-2 border-gray-500"
              id="checkbox"
